...
public:
	...
	virtual PacketID_t getPacketID() const { return CMSG_COMMU_FRIENDS_ADD_FRIEND;}
...
class CCMD208Factory: public MessageFactory
{
public :

	virtual ~CCMD208Factory ()  {}
